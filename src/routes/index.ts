...
// this.router.use("/bank-consents", new BankConsentRoute().router)
    ...
    this.router.get("/session-check", this.indexController.SessionCheck.bind(this.indexController))
    this.router.get("/onboard-guide", this.indexController.onBoardGuideDone.bind(this.indexController))
